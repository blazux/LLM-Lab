...
export default memo(({ data }: ReGLUNodeProps) => {
  return (
    <motion.div
    ...
    >
      ...
      <div className="flex items-center gap-3">
        <div className="w-1 h-10 rounded-full bg-cat-ffn" />
        <div className="p-2 rounded bg-slate-700">
          <Triangle className="w-4 h-4 text-slate-300" />
        </div>
        <div>
          <div className="text-slate-200 font-medium text-sm">ReGLU</div>
